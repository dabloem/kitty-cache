...
/**
 * User: treeder, innovativeravi Date: Mar 24, 2009 Time: 7:40:14 PM
 */
public interface KCache<K, V> {
	 ...
	 *            later point of time or to delete the entry before its expiry
	 *            time.
	 * @param value
	 *            The actual object that is to be cached.
	 * @param secondsToLive
	 *            expiry time in seconds. so if the cache entry needs to be
	 ...
	 * 
	 * @param key
	 *            handle of the entry with which the object has been cached.
	 ...
	 * 
	 * @param collection
	 *            Collection of keys for which the cache entries need to be
	 *            returned.
